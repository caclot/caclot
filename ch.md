...
我即将前往香港大学攻读计算机科学硕士。喜欢开发一些实用的 App 和桌面小工具，把日常生活里那些微小但真实的摩擦，变成可以被软件解决的问题。
...
- 研究兴趣：`大模型对齐`、`音频基础模型`、`具身智能`。
- 长期好奇：`计算神经科学`、`类脑计算`、`神经形态工程`、认知科学、心理学、法律与语言学。
- 写代码之外，喜欢羽毛球、音乐，也喜欢追着脑子里突然冒出来的问题跑一会儿。
- 三分钟热度，也有三分钟收获。

<br clear="right">

## <img src="https://media2.giphy.com/media/QssGEmpkyEOhBCb7e1/giphy.gif?cid=ecf05e47a0n3gi1bfqntqmob8g9aid1oyj2wr3ds3mg700bl&rid=giphy.gif" width="25"> 技能
...
<p>
  ...
  <img src="https://img.shields.io/badge/Tauri-FFC131?style=for-the-badge&logo=tauri&logoColor=222222" alt="Tauri" />
...
<p>
  ...
  <img src="https://img.shields.io/badge/MyBatis-BF0000?style=flat-square&logoColor=white" alt="MyBatis" />
  ...
  <img src="https://img.shields.io/badge/Transformers-FFD21E?style=flat-square&logo=huggingface&logoColor=222222" alt="Transformers" />
  <img src="https://img.shields.io/badge/PyTorch%20Audio-EE4C2C?style=flat-square&logo=pytorch&logoColor=white" alt="PyTorch Audio" />
...
这些粗糙的小项目暂时先留在幕后，等它们长成我愿意分享的样子再登场。
...
- 准备开启在港大计算机科学的新阶段。
- 学习软件工程、人工智能，以及把想法揉成可用工具这门有点混乱的手艺。
- 探索 AI Agent、音频基础模型与具身智能。
- 生活递来一个足够有趣的小问题时，就顺手做个小应用试着解决它。
- 继续沿着音乐、心理学、认知科学、神经科学、法律与语言里冒出的好奇心走走停停。
